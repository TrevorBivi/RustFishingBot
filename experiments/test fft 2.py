...
def check_var(var, nosim_var, snap_points, catch_points):
    ...
    #print('&& var checktime',t2-t1,t3-t2)
    dbg('%check_var',1)
    return all_objs
'''
...
DEF_VAR = {
'freq_0': -0.09329156912662259,
'freq_1': -0.06942976442050827,
'freq_2': -0.030205145627117902,
'freq_3': -0.020517108811970514,
'freq_4': 0.022099252840634853,
'freq_5': 0.5200235026305314,
'freq_6': 1.027098212947675,
'freq_7': 0.8165181792352137,
'freq_0b': 2.1380983695476816,
'freq_1b': 1.0489240897032903,
'freq_2b': 0.5,
'freq_3b': 0.11673739602607798,
'freq_4b': 0.1,
'freq_5b': 0.1,
'freq_6b': 0.34158475174690955,
'freq_7b': 0.19419247803598078,
'xy_ratio': 0.3316214575292773,
'samples': 16,
'avg_pos': True,
'max_swing': 1850,
'dist_m': 0.34098306169114306,
'dist_0': 11.201302854935287,
'dist_max_punishment': 1.7445353883454027}
DEF_NOSIM_VAR = {'overshootp': 0.09740053614449569,
'overshoot_cap': 19.646411765812463,
'min_trigger_val': 20.310915087376674,
'time_m': 1.6448039555747183,
'time_0': 2.611442146483848,
'max_pass': 501.66698839835766,
'swing_max': 265.1261930874385,
'swing_0': 0.5544554667709007,
'swing_m': -112.97972095718919}
...
def check_vars( params):
    ...
    while not done:
        ...
        dbg('&check_vars - check var loop ' + str(amnt) + '/' + str(total) + '=' + str(amnt/total),1)
        amnt += 1
        for key in keys:
                ...
                for i in range(amnt_proc):
                    ...
                    for variable_var in variable_vars:
                        ...
                        if variable_var == 'freq_intensities' or variable_var == 'high_freq_intensities':
                            ...
                            var_lists[i][variable_var] = (best_var[variable_var] + (1 - (amnt_proc % 3)) * best_var[variable_var] * rnd.uniform(0.05, 0.15), best_var[variable_var] - DEF_VAR[variable_var] * iter_size * rand1, best_var[variable_var] - DEF_VAR[variable_var] * iter_size * rand2)
